    ...
    [
      ...
      env: [
        ...
        clarity_content_providers: [
          ...
          Clarity.Content.Ash.ApplicationDiagramFlow,
          Clarity.Content.Ash.DomainOverview,
          Clarity.Content.Ash.DomainErDiagram,
          Clarity.Content.Ash.DomainClassDiagram,
          Clarity.Content.Ash.ResourceOverview,
          Clarity.Content.Ash.ResourceErDiagram,
          Clarity.Content.Ash.ResourceClassDiagram,
          Clarity.Content.Ash.PolicyDiagram,
