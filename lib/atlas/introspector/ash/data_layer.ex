case Code.ensure_loaded(Ash) do
  {:module, Ash} ->
    defmodule Atlas.Introspector.Ash.DataLayer do
      @moduledoc false
      ...
      alias Atlas.Vertex
      alias Atlas.Vertex.Ash.Resource
      ...
      def introspect(graph) do
        ...
        data_layer_vertices =
          ...
          |> Map.new(fn data_layer ->
            ...
            Atlas.Introspector.attach_moduledoc_content(data_layer, graph, data_layer_vertex)
